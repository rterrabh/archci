 ...
 */
public class A234TestCase extends DCLTestCase { 

	public void test01() throws Exception {
		List<ArchitecturalDrift> violations = this.validateSystem("com.example.a.A234 must-create com.example.b.B234"); //Define the constraint to be validated
		...
		assertEquals("com.example.a.A234",aad.getClassNameA());
		assertEquals("com.example.b.B234",aad.getModuleNameB());
	}
